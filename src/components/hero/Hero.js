...
const Hero = () => {
  ...
  const data = [
    "https://images.pexels.com/photos/5746087/pexels-photo-5746087.jpeg?auto=compress&cs=tinysrgb&w=1660&dpr=1",
    "https://images.pexels.com/photos/274973/pexels-photo-274973.jpeg?auto=compress&cs=tinysrgb&w=1600&dpr=1",
    "https://images.pexels.com/photos/19090/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=1660&dpr=1",
  ];
  const prevSlide = () =>{
  ...
  return (
    ...
    <section className= ''>
      ...
      <div className=" slider flex w-screen m-0 p-0  bg-cover"style={{transform:`translateX(-${currenSlide * 100}vw) `}}>
        <img className=" " src={data[0]} alt="" />
